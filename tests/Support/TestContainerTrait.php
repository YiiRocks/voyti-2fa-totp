...
trait TestContainerTrait
{
    ...
    protected function createTestContainer(array $overrides = []): ContainerInterface
    {
        ...
        $definitions = array_merge(
            ...
            (static fn(array $params): array => require $totpPath . '/config/di.php')($params),
        );
        ...
        $definitions = array_merge($definitions, [
            ...
            TranslatorInterface::class => (static function () use ($corePath, $twoFaPath, $totpPath, $validatorCategorySource): TranslatorInterface {
                ...
                $translator->addCategorySources(
                    ...
                    new CategorySource('voyti-2fa-totp', new MessageSource($totpPath . '/resources/messages'), new SimpleMessageFormatter()),
