...
/**
 * In-memory SQLite with the tables the 2FA flows touch: a plain `user` (no auth_tf_* columns - 2FA
 * state lives in `user_two_factor`), plus `user_two_factor` and `user_backup_code`.
 */
